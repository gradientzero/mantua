...
*[Figures: initial screen of the solo-harness app; sprite editor of the solo-harness app; unsuccessful attempt to play the created level.]*
...
*[Figures: initial screen of the full-harness app; its sprite editor; the built-in AI feature generating a level; playing the generated game.]*
...
Based on the prompt, I was expecting a program where I could create melodies, harmonies, and drum patterns, arrange them into a song, and get help from an integrated agent along the way. *[A video of the result follows in the original post.]*
